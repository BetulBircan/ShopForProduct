	...
	<div>
        ...
        <div class="card">
            <Carousel :value="populars" :numVisible="3" :numScroll="1" :responsiveOptions="responsiveOptions" class="custom-carousel" :circular="true" :autoplayInterval="3000">
                <template #header>
                    <h5 class="d-flex align-items-center justify-content-center py-3">Popüler Ürünler</h5>
                </template>
                <template #item="slotProps">
                    <div class="product-item">
                        <div class="product-item-content">
                            <div class="mb-3">
                                <router-link to="/popular"><img :src="slotProps.data.imageurl" :alt="slotProps.data.title" class="product-image"  /></router-link>
